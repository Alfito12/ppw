...
with Data :
   st.title("""UTS PPW A""")
   st.text('Alfito Wahyu kamaly 200411100079')
   ...
   st.text("""
            ...
            5) Label""")
   st.subheader('Data')
   data=pd.read_csv('https://raw.githubusercontent.com/Alfito12/ppw/main/ptalabel.csv')
   data

with Ekstraksi :

   st.subheader('Term Frequency (TF)')
   tf = pd.read_csv('https://raw.githubusercontent.com/Alfito12/ppw/main/TF.csv')
   tf
   
   st.subheader('Logarithm Frequency (Log-TF)')
   log_tf = pd.read_csv('https://raw.githubusercontent.com/Alfito12/ppw/main/log_TF.csv')
   log_tf
   
   st.subheader('One Hot Encoder / Binary')
   oht = pd.read_csv('https://raw.githubusercontent.com/Alfito12/ppw/main/OneHotEncoder%20(1).csv')
   oht
   
   st.subheader('TF-IDF')
   tf_idf = pd.read_csv('https://raw.githubusercontent.com/Alfito12/ppw/main/TF-IDF.csv')
   tf_idf
